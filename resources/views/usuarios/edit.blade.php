...
<div class="container">
  ...
  @method('PATCH')<!--SIRVE PARA ACTUALIZAR LOS DATOS DIRECTAMENTE CON EL METODO UPDATE-->
  @csrf
    <div class="row">
      ...
      <div class="form-group col-md-6">
        <label >Email</label>
        <input type="pemail" name="email" class="form-control" value="{{$user->email}}" placeholder="Email">
      </div>
    </div>
    <div class="row">
      <div class="form-group col-md-6">
      ...
      <div class="form-group col-md-6">
        <label >Confirmas contrasena <span class="small">(Opcional)</span></label>
